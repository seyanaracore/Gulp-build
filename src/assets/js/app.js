            ...
            if (settings.on === "grab") {
               ...
               $source
                  .on("mouseenter.zoom", (e) => {
                     if (!window.isTouchZoom) start(e);
                  })
                  .on("mouseleave.zoom", (e) => {
                     if (!window.isTouchZoom) stop(e);
                  })
                  .on(mousemove, (e) => {
                     if (!window.isTouchZoom) zoom.move(e);
                  });
            }
